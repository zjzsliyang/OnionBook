...
| ------ | ---------------------------------------- | -------------------------- | ---------------------------------------- |
| 主页     | /onionbook/home                          |                            | 1. 各一级分类的5本打折的图书：名字、折前价格、折后价格、图片、评分；2. 10本最新出版的图书：名字、折前价格、折后价格、图片、评分；3. 评分前前的本图书：名字、折前价格、折后价格、图片、评分（要知道分别排第几、并且排好顺序）；3. 最新出版的40本图书：名字、折前价格、折后价格、图片（要知道分别排第几、并且排好顺序）；4.  图书销量（总和）最高的作者：名字、简介、图片、写所有的其他书：名字、折前价格、折后价格、图片、评分；5. 广告：图片。 |
